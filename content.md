...
Die vorherigen Kapitel haben schon einige Aspekte angesprochen, die beim Speichern von Daten sinnvoll und wichtig ist, wie die Anreicherung mit Metadaten (s. Kap. [6. Metadaten](#6. metadaten)).
...
- Sinnvolles und konsistentes Dateiablagesystem
  ...
  - In einer README-Textdatei kann das System auf oberster Ebene erläutert werden; das ist gerade bei der Arbeit in geteilten Dateiablagesystemen und/oder bei größeren Arbeitsgruppen empfehlenswert
